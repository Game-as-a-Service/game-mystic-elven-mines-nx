...
class SaboteurGameDataTest {
    ...
    void testToData() {
        ...
        var game = new SaboteurGame(
                ...
                defaultPlayerBuilder("B").hand(new Sabotage(ToolName.MINE_CART)).build(),
                defaultPlayerBuilder("C").hand(new RockFall()).build()
        ),
